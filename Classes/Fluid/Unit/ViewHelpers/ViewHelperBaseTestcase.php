...
abstract class ViewHelperBaseTestcase extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->arguments = [];
        $this->renderingContext = $this->getAccessibleMock(\TYPO3Fluid\Fluid\Tests\Unit\Core\Rendering\RenderingContextFixture::class, ['getControllerContext', 'setControllerContext']);
